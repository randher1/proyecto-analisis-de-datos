...
# Sumar la columna 'precio'
money_sum = int(df['precio'].sum())
home_cant = str(df['precio'].count())
# Formatear la suma utilizando el componente
formatted_number = money_format(money_sum)
...
anno = ui.HTML(
    '<spam style="font-size:24px; font-weight: bold; text-align: right;">2024</spam>'
)
